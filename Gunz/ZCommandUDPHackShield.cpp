...
void ZCommandUDPHackShield::Init()
{
	...
	AddDeniedCommand(MC_ADMIN_CHAT);
	AddDeniedCommand(MC_ADMIN_ALLCOMMANDS);
	AddDeniedCommand(MC_ADMIN_ALLCOMMANDS_NOTARGET);
	...
	AddDeniedCommand(MC_REQUEST_NEWS);
	...
	AddDeniedCommand(MC_MATCH_ASK_CLANPASSWORD);
	...
	AddDeniedCommand(MC_MATCH_UPDATE_PREGAME);
	AddDeniedCommand(MC_MATCH_LADDER_SEARCH_RIVAL);
	AddDeniedCommand(MC_MATCH_LADDER_REQUEST_CANCEL_CHALLENGE);
	AddDeniedCommand(MC_MATCH_LADDER_REQUEST_CANCEL_CHALLENGE_NEW);
	AddDeniedCommand(MC_MATCH_LADDER_CANCEL_CHALLENGE);
	AddDeniedCommand(MC_MATCH_LADDER_CANCEL_CHALLENGE_NEW);
	...
	AddDeniedCommand(MC_MATCH_REQUEST_BUY_CASH_ITEM);
	AddDeniedCommand(MC_MATCH_REQUEST_BUY_EVENT);
	AddDeniedCommand(MC_MATCH_RESPONSE_BUY_CASH_ITEM);
	AddDeniedCommand(MC_MATCH_RESPONSE_BUY_EVENT);
	...
	AddDeniedCommand(MC_MATCH_CALLVOTE_PAUSE);
	AddDeniedCommand(MC_MATCH_NOTIFY_CALLVOTE_PAUSE);
	AddDeniedCommand(MC_MATCH_NOTIFY_PAUSE);
	AddDeniedCommand(MC_MATCH_NOTIFY_RESUME);
	AddDeniedCommand(MC_MATCH_RESUME);
