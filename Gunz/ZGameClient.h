...
public:
	...
	void RequestCreateClan(char* szClanName, char* szClanPassword);
...
public:
	...
	void GetEncryptSystemMD5HashValue(char* szEncryptMD5Value);
...
#define ZPOSTCMD10(_ID, _P0, _P1, _P2, _P3, _P4, _P5, _P6, _P7, _P8, _P9)	{ MCommand* pC=ZNewCmd(_ID); pC->AP(_P0); pC->AP(_P1); pC->AP(_P2); pC->AP(_P3); pC->AP(_P4); pC->AP(_P5); pC->AP(_P6); pC->AP(_P7) ; pC->AP(_P8) ; pC->AP(_P9) ; ZPostCommand(pC); }
