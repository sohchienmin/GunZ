...
struct ZCONFIG_EXTRA{
	int			nSwordTrailSize, nCharacterZoom;
	bool		bCharacterVisibility, bAutoRecord, bSpecialItemsScroll, bDamageLog, bBulletsholes, bInfoBar, bShotgunSparlke;
};
/// 로케일과 관련된 설정값
...
//	bool	GetIMESupport()			{ return m_Locale.bIMESupport; }
	...
	ZCONFIG_EXTRA* GetExtra()		{ return &m_Extra; }
...
#define Z_SWORD_TRAILSIZE 0
#define Z_SWORD_TRAILSIZE_MAX 9
...
#define Z_CHARACTER_ZOOM_MAX 149
	...
	int ValidateSwordTrailSizeInInt(int i);
	int GetSwordTrailSizeInInt();

	int ValidateCharacterZoomInInt(int i);
	int GetCharacterZoomInInt();
public:
	// 현재 디폴트 언어가 선택되어 있는가
...
#define ZTOK_EXTRA							"EXTRA"
#define ZTOK_EXTRA_SWORDTRAIL				"SWORDTRAIL"
#define ZTOK_EXTRA_CHARACTERZOOM			"CHARACTERZOOM"
#define ZTOK_EXTRA_ITEMSSCROLL				"ITEMSSCROLL"
#define ZTOK_EXTRA_CHARACTERVISIBILITY		"CHARACTERVISIBILITY"
#define ZTOK_EXTRA_AUTORECORD				"AUTORECORD"
#define ZTOK_EXTRA_DAMAGELOG				"DAMAGELOG"
#define ZTOK_EXTRA_BULLETSHOLES				"BULLETSHOLES"
#define ZTOK_EXTRA_SHOTGUNSPARLKE			"SHOTGUNSPARLKE"
#define ZTOK_EXTRA_INFOBAR					"INFOBAR"
...
#define ZTOK_AUDIO_3D_SOUNDe			"ESOUND_3D"
...
#define Z_AUDIO_3D_SOUNDe		(ZGetConfiguration()->GetAudio()->b3DSounde)
...
#define Z_EXTRA_CHARACTERZOOM (ZGetConfiguration()->GetExtra()->nCharacterZoom)
#define Z_EXTRA_SWORDTRAIL		(ZGetConfiguration()->GetExtra()->nSwordTrailSize)
#define Z_EXTRA_ITEMSSCROLL		(ZGetConfiguration()->GetExtra()->bSpecialItemsScroll)
#define Z_EXTRA_CHARACTERVISIBILITY		(ZGetConfiguration()->GetExtra()->bCharacterVisibility)
#define Z_EXTRA_AUTORECORD   (ZGetConfiguration()->GetExtra()->bAutoRecord)
#define Z_EXTRA_DAMAGELOG    (ZGetConfiguration()->GetExtra()->bDamageLog)
#define Z_EXTRA_BULLETSHOLES  (ZGetConfiguration()->GetExtra()->bBulletsholes)
#define Z_EXTRA_SHOTGUNSPARLKE (ZGetConfiguration()->GetExtra()->bShotgunSparlke)
#define Z_EXTRA_INFOBAR (ZGetConfiguration()->GetExtra()->bInfoBar)
