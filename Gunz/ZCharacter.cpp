...
static ZANIMATIONINFO g_AnimationInfoTableLower[ZC_STATE_LOWER_END] = {
	...
	{ "dance1", true, false, false, false },
	{ "dance2", true, false, false, false },
	{ "dance3", true, false, false, false },
...
void ZCharacter::CheckDrawWeaponTrack()
{
	...
	m_pVMesh->SetDrawTracks(bDrawTracks, ZGetConfiguration()->GetSwordTrailSizeInInt());
...
*/
	...
	ELSE_IF_Lower_ENUM(ZC_STATE_DANCE1)
	ELSE_IF_Lower_ENUM(ZC_STATE_DANCE2)
	ELSE_IF_Lower_ENUM(ZC_STATE_DANCE3)
