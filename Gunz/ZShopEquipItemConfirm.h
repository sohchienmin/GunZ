...
public:
	void Open(ZITEMCOUNTDLG_MODE mode, const char* szItemName, MBitmap* pIcon, int price, int unlimitedprice, bool bIsCash, bool bIsEvent, int nMin, int nMax, IItemCountDlgDoneHandler* pHandler);
	void Close();
	void UpdateDlg();
	void AddCount(int n);
