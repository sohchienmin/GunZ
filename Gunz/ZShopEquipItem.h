...
public:
	...
	virtual bool GetPrice(bool& out_bCash, bool& out_bEvent, int& out_nPrice) = 0;
	virtual const char* GetPriceText(char* szBuf);

	void OpenSimpleConfirmDlg(ISimpleConfirmDlgDoneHandler* pDoneHandler);
	void OpenCountableConfirmDlg(const char* szItemName, MBitmap* pIconBmp, int nPrice, int UnlimitedPrice, bool bIsCash, bool bIsEvent, int nMax, IItemCountDlgDoneHandler* pDoneHandler, bool bCash);
...
public:
	...
	bool GetPrice(bool& out_bCash, bool& out_bEvent, int& out_nPrice);
	virtual void Buy();
...
public:
	...
	bool GetPrice(bool& out_bCash, bool& out_bEvent, int& out_nPrice) { return false; }
	virtual void Buy();
};
...
public:
	...
	void OpenCountableConfirmDlg(const char* szItemName, MBitmap* pIconBmp, int nPrice, int UnlimitedPrice, bool bIsCash, bool bIsEvent, int nMax, IItemCountDlgDoneHandler* pDoneHandler);
