...
public:
	...
	void SetPicked(bool bIsPicked)  { m_bIsPicked = bIsPicked; }
	const char* GetPickedInfo()	{ return m_TargetInfo; }
	void SetPickedInfo(const char* pszTargetPlayer)	{ strcpy(m_TargetInfo, pszTargetPlayer); }
