			...
			: MWidget(szName, pParent, pListener)
{
	...
	m_pRoomDodgeFrame = MBitmapManager::Get("banner_clan_dodge.bmp");
...
void ZClanListBox::SetInfo(int nIndex, int nEmblemID, const char *szName, bool bDodge, int nPlayers)
{
