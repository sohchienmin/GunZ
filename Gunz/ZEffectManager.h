...
#define EMPTYCARTRIDGE_COUNT	2
	...
	RMesh*	m_pDashEffect;
	RMesh*	m_pDashEffectRed;
	RMesh*	m_pDashEffectGreen;
	RMesh*	m_pDashEffectBlue;
	RMesh*	m_pDashEffectYellow;
	RMesh*	m_pDashEffectCyan;
	RMesh*	m_pDashEffectPurple;
...
//	void AddEnchantPoison(ZObject* pObj);
	...
	void AddDashEffect(rvector& Target, rvector& TargetNormal, ZObject* pObj, int nDashColor = 0);
