...
DECLARE_LISTENER(ZGetNewsListener)
/*
...
DECLARE_LISTENER(ZGetUnlimitedRentButtonListener)
...
DECLARE_LISTENER(ZGetCreateCharacterRedColorListener);
DECLARE_LISTENER(ZGetCreateCharacterGreenColorListener);
DECLARE_LISTENER(ZGetCreateCharacterBlueColorListener);
// 리플레이 브라우져 관련
...
DECLARE_LISTENER(ZGetShopAllFilterListener);
DECLARE_LISTENER(ZGetEquipAllFilterListener);
DECLARE_LISTENER(ZGetShopItemListFilterListener);
DECLARE_LISTENER(ZGetEquipListItemFilterListener);
DECLARE_LISTENER(ZGetDefaultCharacterZoomListener)
DECLARE_LISTENER(ZGetUpdateClanPassword)
DECLARE_LISTENER(ZGetUnlockMyChannel)
DECLARE_LISTENER(ZGetLockMyChannel)
DECLARE_LISTENER(ZGetSumbitPassword)
DECLARE_LISTENER(ZGetBeforeButtonListener)
DECLARE_LISTENER(ZGetPlayButtonListener)
DECLARE_LISTENER(ZGetAfterButtonListener)
