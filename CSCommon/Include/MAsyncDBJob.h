...
public:
	MAsyncDBJob_CreateChar(const MUID& uid, int nAID, const char* szCharName, int nCharNum, int nSex, int nHair, int nFace, int nCostume, int nRed, int nGreen, int nBlue)
...
public:
	...
	bool Input(const TCHAR* szClanName, const TCHAR* szClanPassword, const int nMasterCID, const MUID& uidMaster);
	virtual void Run(void* pContext);
	...
	const char* GetClanPassword() { return m_szClanPassword; }
};
////////////////////////////////////////////////////////////////////////////////////////////////////
