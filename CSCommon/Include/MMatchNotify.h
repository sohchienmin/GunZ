...
#define MATCHNOTIFY_IGNORE_ALREADY_EXIST	257
#define MATCHNOTIFY_IGNORE_TOO_MANY_ADDED	259
#define MATCHNOTIFY_IGNORE_ADD_SUCCEED		260
#define MATCHNOTIFY_IGNORE_REMOVE_SUCCEED	261
