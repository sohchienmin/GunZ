...
struct MMatchAccountInfo
{
	...
	int						m_nCCode;
	int						m_nDonationCoins;
	int						m_nEventCoins;
	SYSTEMTIME				m_NextTime;
	MMatchAccountInfo() : m_nAID(-1), m_nUGrade(MMUG_FREE), m_nPGrade(MMPG_FREE), m_nCCode(0), m_nDonationCoins(0), m_nEventCoins(0)
	{
...
public :
	...
	unsigned long int st_nLastStageChat;
...
public:
	...
	void SetIgnoreInfo(MMatchIgnoreInfo* pFriendInfo);
	bool DBIgnoreListRequested()	{ return m_bDBIgnoreListRequested; }
