...
void MAddSharedCommandTable(MCommandManager* pCommandManager, int nSharedType)
{
	...
	if(nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT){
		...
		C(MC_ADMIN_ALLCOMMANDS, "Admin.AllCommands", "Request All Commands", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "strTarget")
			P(MPT_STR, "strCommand")

		C(MC_ADMIN_ALLCOMMANDS_NOTARGET, "Admin.AllCommands.NoTarget", "Request All Commands No target", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "strCommand")


		C(MC_ADMIN_CHAT, "Admin.Chat", "Admin Chat", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "strMessage")
		...
		C(MC_REQUEST_NEWS, "Match.Request.News", "Request News", MCDT_MACHINE2MACHINE)
		C(MC_RESPONSE_NEWS, "Match.Response.News", "Response News", MCDT_MACHINE2MACHINE)
			P(MPT_BLOB, "NewsBlob");
...
//			P(MPT_BLOB, "SKey")
		...
		C(MC_MATCH_REQUEST_BUY_CASH_ITEM, "Match.RequestBuyCashItem", "Request Buy Cash Item", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChar")
			P(MPT_UINT, "ItemID")
			P(MPT_UINT, "ItemCount")
			P(MPT_BOOL, "IsUnlimited")

		C(MC_MATCH_REQUEST_BUY_EVENT, "Match.RequestBuyEvent", "Request Buy Event", MCDT_MACHINE2MACHINE)
			P(MPT_UINT, "ItemID")

		C(MC_MATCH_RESPONSE_BUY_EVENT, "Match.ResponseBuyEvent", "Response Buy Event", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "message")
			P(MPT_INT, "result")

		C(MC_MATCH_RESPONSE_BUY_CASH_ITEM, "Match.ResponseBuyCashItem", "Response Buy Cash Item", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "message")
			P(MPT_INT, "result")
		...
		C(MC_MATCH_RESPONSE_CHARACTER_ITEMLIST, "Match.ResponseCharacterItemList", "Response Character Item List", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "Bounty")
			P(MPT_INT, "BountyPlus")
			P(MPT_INT, "EventCoins")
			P(MPT_BLOB, "EquipItemList")
			P(MPT_BLOB, "ItemList");
			P(MPT_BLOB, "GambleItemList")
		...
		C(MC_MATCH_IGNORE_ADD, "Match.Ignore.Add", "Add to ignore", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "Name")
		C(MC_MATCH_IGNORE_REMOVE, "Match.Ignore.Remove", "Remove from ignore", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "Name")
		C(MC_MATCH_IGNORE_LIST, "Match.Ignore.List", "List Ignore", MCDT_MACHINE2MACHINE)
		C(MC_MATCH_RESPONSE_IGNORELIST, "Match.Response.IgnoreList", "Response List Ignore", MCDT_MACHINE2MACHINE)
			P(MPT_BLOB, "IGnoreList")

		C(MC_MATCH_REMOVE_PASSWORD, "Match.Remove.Password", "Remove Clan Password", MCDT_MACHINE2MACHINE)
		C(MC_MATCH_UPDATE_PASSWORD, "Match.Clan.UpdatePassword", "Clan Update password", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "buffer")
		C(MC_MATCH_CLAN_PASSWORDRESPONSE, "Match.Clan.PasswordRespone", "Clan password response", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "buffer")
		C(MC_MATCH_ASK_CLANPASSWORD, "Channel.Join", "Join a Channel", MCDT_MACHINE2MACHINE)
			P(MPT_BOOL, "Value")
			P(MPT_STR, "String")
			P(MPT_STR, "ChannelString")
			P(MPT_UID, "TempUID")
...
//	CA("connect", "Net.Connect");
	...
	C(MC_MATCH_PLAYERWARS_RANDOM_MAPS, "Maps", "Maps", MCDT_MACHINE2MACHINE)
		...
		P(MPT_INT, "2");
		P(MPT_INT, "3");
	C(MC_MATCH_PLAYERWARS_LEAVE_RANDOM_MAPS, "Maps", "Maps", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "1");
		P(MPT_INT, "2");
		P(MPT_INT, "3");
